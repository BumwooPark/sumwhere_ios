...
class JoinView: UIView{
  ...
  let emailField: SkyFloatingLabelTextField = {
    ...
    field.titleFont = UIFont.AppleSDGothicNeoRegular(size: 16)
    field.placeholderFont = UIFont.AppleSDGothicNeoRegular(size: 16)
    field.font = UIFont.AppleSDGothicNeoRegular(size: 16)
